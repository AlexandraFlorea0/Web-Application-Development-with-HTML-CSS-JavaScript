...
# Functie pentru a trata cererea unui client
def handle_client(clientsocket):
    ...
    numeFisier = 'C:\Proiecte - PW\proiect-1-Alexandra0100\continut' + numeResursaCeruta
    ...
    try:
        ...
        # Se comprimă conținutul fișierului în memorie
        fisier_compresat = gzip.compress(fisier.read())

        # se trimite raspunsul
        clientsocket.sendall('HTTP/1.1 200 OK\r\n'.encode())
        clientsocket.sendall(('Content-Length: ' + str(len(fisier_compresat)) + '\r\n').encode())
        ...
        # Trimite conținutul comprimat
        clientsocket.sendall(fisier_compresat)
...
while True:
    ...
    # Pornim un fir de execuție (thread) pentru a trata cererea clientului
